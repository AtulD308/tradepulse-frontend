...
export const fetchCoinList = (page, silent = false) => async (dispatch) => {
    if (!silent) {
  ...
  export const getTop50CoinList = (silent = false) => async (dispatch) => {
    if (!silent) {
  ...
  export const fetchTreadingCoinList = (silent = false) => async (dispatch) => {
    if (!silent) {
  ...
  export const fetchMarketChart = ({coinId, days, jwt, silent = false}) => async (dispatch) => {
    if (!silent) {
  ...
  export const fetchCoinDetails = ({coinId,jwt,silent = false}) => async (dispatch) => {
    if (!silent) {
