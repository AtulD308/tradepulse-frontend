    ...
    >
      ...
      <section className="max-w-7xl mx-auto px-6 py-20 border-t border-white/5 relative">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          {/* LEFT MOBILE MOCKUP GRAPHIC */}
          <div className="lg:col-span-6 relative w-full h-[400px] flex items-center justify-center">
            {/* Ambient Mobile Background Glow */}
            <div className="absolute w-[300px] h-[300px] bg-[#00ffa3]/5 rounded-full blur-[80px] pointer-events-none animate-pulse" />
            
            {/* Outer Mobile Frame */}
            <div className="relative w-[240px] h-[400px] rounded-[36px] bg-black border-4 border-white/10 shadow-[0_40px_80px_rgba(0,0,0,0.9)] p-3 overflow-hidden flex flex-col justify-between hover:scale-105 transition-transform duration-300">
              {/* Camera Notch */}
              <div className="absolute top-2 left-1/2 -translate-x-1/2 w-20 h-4 bg-black rounded-full z-20" />
              
              {/* App Screen mock */}
              <div className="flex-1 bg-[#050a0e] rounded-[28px] overflow-hidden p-3.5 flex flex-col justify-between relative text-left">
                {/* Header info */}
                <div className="flex items-center justify-between mt-3 text-[8px] font-bold text-white">
                  <span>TRADEPULSE APP</span>
                  <span className="text-[#00ffa3]">LIVE</span>
                </div>

                {/* Balance display */}
                <div className="mt-4">
                  <p className="text-[8px] text-[#5a7a6a] font-bold uppercase tracking-wider">Your Balance</p>
                  <p className="text-lg font-black text-white font-mono mt-0.5">$9,834.33</p>
                  <p className="text-[8px] text-[#00ffa3] font-bold font-mono mt-0.5">▲ +4.65% (+$420)</p>
                </div>

                {/* Graph mockup */}
                <div className="h-16 w-full my-4 flex items-end">
                  <svg className="w-full h-full stroke-[#00ffa3] fill-none stroke-[2.5]" viewBox="0 0 160 60">
                    <path d="M 0,50 Q 20,20 40,35 T 80,10 T 120,40 T 160,5" />
                    <path d="M 0,50 Q 20,20 40,35 T 80,10 T 120,40 T 160,5 L 160,60 L 0,60 Z" fill="url(#appWidgetGrad)" opacity="0.1" stroke="none" />
                    <defs>
                      <linearGradient id="appWidgetGrad" x1="0" y1="0" x2="0" y2="1">
                        <stop offset="0%" stopColor="#00ffa3" />
                        <stop offset="100%" stopColor="transparent" />
                      </linearGradient>
                    </defs>
                ...
                {/* Buy Sell mock CTAs */}
                <div className="grid grid-cols-2 gap-2 text-[8px] font-bold text-center">
                  <span className="bg-[#00ffa3]/10 border border-[#00ffa3]/35 text-[#00ffa3] py-2 rounded-lg">BUY SOL</span>
                  <span className="bg-[#ff4d6d]/10 border border-[#ff4d6d]/35 text-[#ff4d6d] py-2 rounded-lg">SELL ETH</span>
                </div>
              </div>
            </div>
          </div>

          {/* RIGHT TEXT & QR CODE INFO */}
          <div className="lg:col-span-6 flex flex-col items-start text-left space-y-6">
            <h2 className="text-3xl sm:text-4xl font-extrabold text-white tracking-tight leading-tight">
              Trade Anywhere, <br/>
              <span className="bg-gradient-to-r from-[#00ffa3] to-cyan-400 bg-clip-text text-transparent">Anytime</span>
            </h2>

            <p className="text-sm sm:text-base text-[#8aa898] leading-relaxed">
              Stay synchronized with global order books, execute trades, and query AI assistant forecasts directly on your mobile device.
            </p>

            {/* QR Code integration */}
            <div className="inline-flex items-center gap-4 bg-[#0c1419]/90 border border-white/5 p-4 rounded-2xl shadow-[0_20px_40px_rgba(0,0,0,0.5)]">
              <div className="w-16 h-16 bg-white rounded-xl flex items-center justify-center p-1.5 shrink-0 shadow-[0_0_15px_rgba(255,255,255,0.1)]">
                <QrCode className="w-full h-full text-black" />
              </div>
              <div className="text-left">
                <h4 className="text-xs font-extrabold text-white uppercase tracking-wider">Scan to Download</h4>
                <p className="text-[10px] text-[#5a7a6a] font-semibold mt-1">Supports iOS 15+ and Android 10+ software updates.</p>
              </div>
            </div>
            ...
            <div className="flex flex-wrap items-center gap-3 pt-2">
              <button 
                onClick={() => navigate("/signup")}
                className="bg-white/5 border border-white/10 hover:border-white/20 px-5 py-3 rounded-xl flex items-center gap-2.5 transition-all"
              >
                <Smartphone className="w-5 h-5 text-white" />
                <div className="text-left">
                  <p className="text-[8px] text-[#5a7a6a] font-bold uppercase">Download on the</p>
              ...
              >
                ...
                <div className="text-left">
                  <p className="text-[8px] text-[#5a7a6a] font-bold uppercase">Get it on</p>
      ...
      {/* ====================================================
          9.25 LEARN ACADEMY SECTION
          ==================================================== */}
      <section id="learn" className="max-w-7xl mx-auto px-6 py-24 border-t border-white/5 relative overflow-hidden">
        {/* Ambient background glows */}
        <div className="absolute top-1/3 right-1/4 w-[350px] h-[350px] bg-cyan-500/[0.015] blur-[120px] rounded-full pointer-events-none" />
        <div className="absolute bottom-1/3 left-1/4 w-[250px] h-[250px] bg-[#00ffa3]/[0.01] blur-[100px] rounded-full pointer-events-none" />

        <div className="relative z-10 flex flex-col items-start text-left mb-16">
          ...
          <h2 className="text-3xl sm:text-5xl font-extrabold text-white tracking-tight leading-tight max-w-3xl">
            ...
            <span className="block mt-2 bg-gradient-to-r from-[#00ffa3] via-[#00e5a0] to-[#00ffa3] bg-clip-text text-transparent">
              AI-Driven Quantitative Intelligence
            </span>
          </h2>
          
          <p className="text-sm sm:text-base text-[#8aa898] leading-relaxed mt-6 max-w-2xl">
            Decoupling complex multi-market micro-structures. Select a terminal module below to load the complete technical specifications and algorithmic blueprints.
          </p>
        </div>
                ...
                {backtestChartData && backtestChartData.length > 0 && (
                  <svg className="w-full h-full overflow-visible" preserveAspectRatio="none">
                    ...
                    {(() => {
                      ...
                      // Convert percentage coordinates to clean path string
                      ...
                      return (
                        <svg viewBox="0 0 100 100" className="w-full h-full overflow-visible" preserveAspectRatio="none">
                          ...
                          {/* Live pulsing dot at current tick */}
                          {svgPoints.length > 0 && (
                            <circle
      ...
      {/* ====================================================
          LEARN ARTICLE READER MODAL (Slide-down Fullscreen Overlay)
          ==================================================== */}
      {selectedLearnArticle && (
        <div className="fixed inset-0 z-50 bg-[#04090c]/98 backdrop-blur-xl flex flex-col items-center justify-start overflow-y-auto animate-fade-in transition-all duration-300">
          {/* Header Bar */}
